# Spec: Multi-Category Random Wheel Spinner (Next.js 16+ & Neon DB)
...
- **Key Features**:
  - **Multi-Category Support**: Tabs or dropdown selector to switch between categories (Food, Drinks, Locations, Custom).
...
```typescript
// Example of API route code style
...
## Open Questions
- None. (Assumptions confirmed by user).
